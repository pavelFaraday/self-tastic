    ...
    public function getInitiateToken()
    {
        ...
        if ($this->service_result->isSuccess()) {
            if (isset($body->token)) {
                ...
                $this->errors_from_remote[] = __("Could not initate with site: " . $this->destination->getDestination() . " - If it is the remote site, this is normally caused by using the wrong access key to this site or the type (pull/push) is not allowed on the remote site.","wpsynchro");
