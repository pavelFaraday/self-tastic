...
class PopulateFileList extends WPSynchroService
{
    ...
    public function service()
    {
        ...
        $already_running = $this->initPopulate($job_id, $section->id);
    ...
    public function initPopulate($job_id, $section_id)
    {
        ...
        if (is_object($this->state) && $this->state->job_id == $job_id && $this->state->section_id == $section_id) {
            ...
            // Does not exist or has wrong job_id or section_id, so create new and clear database
